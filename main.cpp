 ...
 void frontscreen(void)
{
	...
	drawstring(-60,5,"MAXIMIZE WINDOW FOR BETTER VIEW SITE",GLUT_BITMAP_HELVETICA_12);
    glColor3f(1,0,0.5);
	output(35,160,"KATHMANDU UNIVERSITY");
	glColor3f(1,0,1);
	output(5,150,"DEPARTMENT OF COMPUTER SCIENCE AND ENGINEERING");
	glColor3f(1.0, 0.0, 0.5);
	output(60,130,"A Mini Project On :-");
	glColor3f(0,1,0.5);
	output(38,120,"\"Maze Game USING OPENGL and C\"");
	glColor3f(1,0,0.5);
	output(40,100,"By :-");
	glBegin(GL_LINES);
	glVertex2f(40,98);
	...
	glEnd();
	glColor3f(1,0,0);
	output(40,90,"Ranjit Sapkota and Utkrista Thapa ");
	...
	output(40,50,"");
	glColor3f(1,0,0);
	output(60,50,"Prof. Dhiraj Shrestha");
	glFlush();
...
void timeover()
{
 glClear(GL_COLOR_BUFFER_BIT);
 glColor3f(0,0,1.0);
 output(70,110,"YOUR TIME IS OVER");
 glColor3f(0,1,0);
